...
public class Configuration {
	...
	public Configuration(final String configFilename) throws IOException {
		...
		java.io.InputStream is = Configuration.class.getClassLoader().getResourceAsStream(configFilename);
		if (is == null) {
			throw new IOException("Configuration file not found: " + configFilename);
		}
		configFile.load(is);
		System.out.println("configuration file " + configFilename + " loaded successfully");
	}
}